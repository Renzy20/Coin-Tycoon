...
document.getElementById('loginSubmit').addEventListener('click', () => {
    ...
    if (!username || !password) {
        ...
        enterAccount.textContent = 'Please enter a username and password.';
        invalidRegister.style.display = 'flex';

        // Add event listener for "Invalid" button only once
        invalidButton.removeEventListener('click', emptyClickHandler); // Remove previous handler if it exists
        invalidButton.addEventListener('click', emptyClickHandler);
        return;
    }
    ...
    if (user) {
        ...
        enterAccount.textContent = 'Invalid username or password';
